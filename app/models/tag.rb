class Tag < ActiveRecord::Base
  ...
  def self.find_or_create_with_like_by_name_with_type(name, type)
    find(:first, :conditions => ["name LIKE ? AND taggable_type = ?", name, type]) || create(:name => name, :taggable_type => type)
  end
